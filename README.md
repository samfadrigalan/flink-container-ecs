> Note: This project is still WIP and is copied from [here](https://github.com/apache/flink/tree/release-1.8/flink-container/docker) and was modified for AWS ECS deployment.
